...
exports.invokeRolesPolicies = function () {
  acl.allow([{
    ...
    {
      resources: '/api/subjectsResource/getUserByUserId',
      permissions: '*'
    },
    {
      resources: '/api/subjectsResource/getSubjectListByUserId',
      permissions: '*'
    },
    {
      resources: '/api/subjectsResource/addSubjectByAdmin',
      permissions: '*'
    }
  ]
  }, {
...
exports.isAllowed = function (req, res, next) {
  ...
  if (req.subject && req.user && req.subject.user.id === req.user.id) {
    return next();
  }
